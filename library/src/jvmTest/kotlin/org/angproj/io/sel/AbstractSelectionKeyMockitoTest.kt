...
open class AbstractSelectionKeyMockitoTest : SelectionKeyMockitoTest() {

    override val selectionKey: SelectionKey<String, SelectChannelOperation> = mock<AbstractSelectionKey<String, SelectChannelOperation>>()
